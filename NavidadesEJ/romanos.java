...
public class romanos {
	...
	public static String calcularRomano(int numero) {
		// obtenemos un romano mediante la posicion que nos devuelve getRoman()
		...
		do {
			if (numero >= 1000) {
				...
				int pos = getRoman(String.format("%d", 500 - (numero - (numero - 400))));
				...
				int pos = getRoman(String.format("%d", 50 - (numero - (50 - numero))));
				resultado += romanos[pos];
				resultado += "L";
